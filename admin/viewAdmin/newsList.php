...
<div class="container" style="min-height: 400px;">
    ...
    <div class="col-md-11">
        ...
        echo '<tr>';
            ...
            echo '</td>';
            echo '<td>
            <a href="newsEdit?id='.$row['id'].'">Edit <span class="gliphicon gliphicon-edit" aria-hidden="true"></span></a>
            <a href="newsDel?id='.$row['id'].'">Delete <span class="gliphicon gliphicon-remove" aria-hidden="true"></span></a>
            </td>   ';
